...
// TODO: add back tests with new approach
// QUnit.test( 'Can evenly distribute water', assert => {
//
...
//     } );
//     introModel[ 'evenlyDistributeWater' ]( connectedCups, waterDelta );
//
...
//   }
//
//   testDistribution( [ 0.5, 1.0, 0.5 ], 0.5, [ 0.75, 1.0, 0.75 ], 'adding distribution with full cup' );
//
// } );

QUnit.test( 'placeholder', assert => {
  assert.ok( true, 'we tested' );
} );
