 ...
 * and each container has a maximum of 10 candy bars.
 *
...
export default class NotepadPlateNode extends Node {
  public constructor( plate: NotepadPlate, candyBarDropped: ( candyBar: NotepadCandyBarNode ) => void, providedOptions: NotepadPlateNodeOptions ) {
